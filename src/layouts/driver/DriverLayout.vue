<template>
  <div class="flex min-h-screen bg-gray-50 dark:bg-slate-900 transition-colors duration-200">
    ...
    >
      ...
      <!-- 네비게이션 -->
      <nav
        class="flex-1 py-4 overflow-y-auto scrollbar-thin scrollbar-thumb-gray-300 dark:scrollbar-thumb-slate-600"
      >
        <RouterLink
        ...
        <div
          class="h-px bg-gradient-to-r from-transparent via-gray-300 dark:via-slate-600 to-transparent mx-6 my-4"
        ></div>
      ...
      >
        <div class="flex justify-between items-center">
          <div class="flex items-center gap-4">
            ...
            <h1
              class="text-2xl font-bold bg-gradient-to-r from-blue-600 to-cyan-500 dark:from-cyan-400 dark:to-blue-500 bg-clip-text text-transparent"
            >
              {{ pageTitle }}
            </h1>
          </div>
          ...
          <div class="flex items-center gap-4">
            ...
            >
              ...
              <span
                class="text-sm font-medium text-gray-700 dark:text-slate-200 group-hover:text-white"
              >
                관리자
              </span>
            </div>
